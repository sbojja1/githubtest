...
public final class suggestsol_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <hr>\n");
      out.write("        \n");
      out.write("        <form action=\"suggestsol1.jsp\" method=\"post\">\n");
      ...
      out.write("\n");
      out.write("                <td>\n");
      out.write("                   <select name=\"regno\">\n");
      out.write("                 ");

            Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            Connection con=DriverManager.getConnection("jdbc:odbc:sss","","");
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select regno from postproblem");
            while(rs.next())
              {
