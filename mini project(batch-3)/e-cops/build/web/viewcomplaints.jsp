...
<script type="text/javascript">
  function validate()
  {
       ...
       var suggestion=document.frm.suggestion;
	   if(regno.value== "")
	   {
	   alert("hello plz enter the registration number");
	   regno.focus();
	   return false;
	   }
      if(name.value== "")
       ...
       if(suggestion.value== "")
	   {
	   alert("hello plz enter the Suggestion");
	   suggestion.focus();
	   return false;
       }
  }
...
<center><h1>ADMIN AUTHORITIES</h1></center>
        <hr>
        <br>
            <table border="2" bgcolor="#99ADD3" align="center" cellpadding="3" cellspacing="3">
                <tr>
                    <td>
                    ...
                    <td>
                    <a href="regHandler1.jsp">
                        VIEW REGISTERED COMPLAINTS
                    </a>
                    </td>
                </tr>
          </table>
        <form name="frm" action="sug.jsp" method="post" onsubmit="return validate();">
        <table border="2" align="center" bgcolor="#99ADD3">
           ...
           Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            ...
            <tr>
                ...
                <td>
                    <input type="text"  name="sol<%=i%>" value="<%=rs.getString(4)%>">
                 </td>
                </tr>
               <%
                i++;
